...
// readme:
	...
	/// functions ///
		...
		(: <tips|hints>
			...
			([1]: <2nd-tip>
		#: <examples>
			#[0]: <1st-single-line-example>
			#[1]: <2nd-single-line-example>
			#[3]:
				<3rd-multiline-example-A>
				<3rd-multiline-example-B>
		@: <arguments> of <function> || <values> of <string>|<number>|<boolean>|<regexp>|<date> || <elements> of <array> || <property>&<value> of <object>
			@[0]: <1st-argument_required>
			@[1]: <2nd-argument_required>
				@[1][0]: <1st-argument_required> of <function> <2nd-argument_required>
				@[1][1]: <2nd-argument_required> of <function> <2nd-argument_required>
				@[1]>: <return> of <function>
			@(2): <3rd-argument_optional> {default}
				@[2](0): <1st-option_optional> of <string>|<number>|<boolean>|<regexp>|<date> <2nd-argument_required>
				@[2](1): <2nd-option_required> of <string>|<number>|<boolean>|<regexp>|<date> <2nd-argument_required>
			@[3]: <4th-argument_required>
				@[3][0]: <1st-element_required> of <array> <2nd-argument_required>
				@[3](1): <2nd-element_optional> of <array> <3rd-argument_required> {default}
			@(4): <5th-argument_optional> {default}
				@(4)[p]: <property> of <object> <4th-argument_optional> {default}
					@(4)[p][v]: <value> of <object> <4th-argument_optional> {default}
		>: <return>
			>[0]: <1st-argument> of returned <function>
			>[1]: <2nd-argument> of returned <function>
			>[<prop>]: <property> of returned <object>
			>[<prop>]: <property> of returned <object>
		~: <performance-time_in_ms>
		?: <browser-compatibility>
		%: <usefulness> e.g.: /****/

	/// data types ///
	// <string>|<number>|<integer>|<number+>|<NaN>|<integer+>|<object>|<property>|<array>|<function>|<boolean>|<null>|<undefined>|<class>|<symbol>|<element>|<nodelist>|<svgElement>|variable|<*>
	...
	/// example ///
		...
		#:
			#[0]:
				...
				>>> true
		@:
			@(0): a: <string>|<number>|<boolean>|<null>|<undefined> "The demo argument" {undefined}
		>: <string>|<number>|<boolean>|<null>|<undefined> "Returns the demo argument" {undefined}
		~: 0.12 ms
		?: *
		%: /**/
...
;(function () {
	...
	#:
		...
		#[4]:
			...
			// get parents
			var _parent = j.el(".children<*")
			// get next sibling
			var _next = j.el("#element", 1).nextSibling | j.el("#element+*")
			// get previous sibling
			var _prev = j.el("#element", 1).previousSibling
			// get element and all its siblings
			var _siblings = j.el("#element<*>*")
			// possible but bad for performance (would create an array with 2744 x #element)
			var _el = j.el("#element<*<*<*<*>*>*>*>#element")
		#[5]:
	...
	#:
		#[0]: var dur = 1000; j.anime( function (t) { j.inner.html("#el", 100 * j.linear()( t/dur ); }, dur)
	...
	#:
		#[0]: var dur = 1000; j.anime( function (t) { j.inner.html("#el", 100 * j.ease.in(3)( t/dur ); }, dur)
		#[1]: var dur = 1000; j.anime( function (t) { j.inner.html("#el", 100 * j.ease.out(4)( t/dur ); }, dur)
		#[2]: var dur = 1000; j.anime( function (t) { j.inner.html("#el", 100 * j.ease.inout()( t/dur ); }, dur)
		#[3]: var dur = 1000; j.anime( function (t) { j.inner.html("#el", 100 * j.ease.sin.in()( t/dur ); }, dur)
	@:
		@[in]: "easeIn"
	...
	#:
		#[0]: var dur = 1000; j.anime( function (t) { j.inner.html("#el", 100 * j.combine( j.ease.sin.in(), j.ease.out(6) )( t/dur ); }, dur)
